    ...
    return <div  id="loader1"><div class="loader">Loading...</div></div>
     ...
     return (<>
           ...
           <div className="blogs">
                ...
                <div className="pageWrapper"><button className="page__btn" disabled={this.state.page===0} onClick={()=>{this.setState(state=>{return {loading1:true,page:state.page-1}})}} >{"-"}</button>
