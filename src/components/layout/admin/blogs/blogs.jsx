           ...
           <div className="blogs">
                 {this.state.data.map((data,i)=>{
                   return <div style={{position:"relative"}} className="blogs__item">
                               <textarea value={data.title} className="blogs__item-title"></textarea><br/>
                               <textarea value={data.by} className="blogs__item-info">By <span className="blogs__item-info-by"></span> on <span className="blogs__item-info-date">{data.date}</span></textarea><br/>
                               <textarea value={data.content.slice(0,350)}  className="blogs__item-content"> </textarea><Link to={{pathname:"/admin/blogs:"+data.title,state:{...data}}} className="blogs__item-readMore">...Read More</Link><br/>
